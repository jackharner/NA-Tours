...
const tourSchema = new mongoose.Schema(
    {
        ...
        ratingsAverage: {
            ...
            set: val => Math.round(val * 10) / 10 // rounds to 1 decimal digit, not sure this is best because after enough reviews the average won't change
        },
        ratingsQuantity: {
            type: Number,
            default: 0
...
tourSchema.index({startLocation: '2dsphere'}); // index for geolocation data
